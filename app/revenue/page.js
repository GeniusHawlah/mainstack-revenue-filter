...
export default async function Revenue() {
  ...
  return (
    <main className="pl-28 pt-16 pr-10 sm:pr-14 md:pr-20 lg:pr-28 xl:pr-[140px] ">
      <div className="flex justify-between  gap-x-8 sm:gap-x-16 md:gap-x-20 lg:gap-x-24 xl:gap-x-[7.75rem]">
        {/* //>Chart and balance */}
        ...
        <div className="max-w-[271px] xl:min-w-[271px] whitespace-nowrap">
        <OtherWalletInfo/>
        </div>
      </div>
